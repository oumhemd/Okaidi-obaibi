...
document.getElementById("PE25-TF5-COLLECTION-BAIN-OBF-frCH").style.display="none";
} else {
document.getElementById("PE25-TF5-COLLECTION-BAIN-OBF-deCH").style.display="none";
}
