...
document.getElementById("PE25-TF5-COLLECTION-BAIN-OKF-frCH").style.display="none";
} else {
document.getElementById("PE25-TF5-COLLECTION-BAIN-OKF-deCH").style.display="none";
}
