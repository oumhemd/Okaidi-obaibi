...
document.getElementById("PE25-TF5-COLLECTION-BAIN-OKF-frBE").style.display="none";
} else {
document.getElementById("PE25-TF5-COLLECTION-BAIN-OKF-nlBE").style.display="none";
}