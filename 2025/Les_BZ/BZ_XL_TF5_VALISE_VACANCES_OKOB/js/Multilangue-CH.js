...
document.getElementById("PE25-BZ-TF5-VALISE-VACANCES-OKOB-frCH").style.display="none";
} else {
document.getElementById("PE25-BZ-TF5-VALISE-VACANCES-OKOB-deCH").style.display="none";
}
